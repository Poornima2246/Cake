            ...
            <div key={product.id} className="text-center group">
              <div className="mb-4 relative">
                ...
                <img 
                  src={product.image} 
                  alt={product.name}
                  className="w-1/2 object-cover  mx-auto relative z-10 scale-90 group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              {/* <h3 className="font-script text-xl text-pink-500">{product.name}</h3> */}
            </div>
          ))} 
        </div>
      </section>
